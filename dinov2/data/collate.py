...
def collate_data_and_cast(samples_list, mask_ratio_tuple, mask_probability, dtype, n_tokens=None, mask_generator=None):
    ...
    # print("type(samples_list) ====== {}".format(type(samples_list)))
    # print("type(samples_list[0]) ====== {}".format(type(samples_list[0])))
    # print("samples_list[0].keys() ====== {}".format(samples_list[0].keys()))
    ...
    #         print("i == {}, s[’global_crops‘] === {}".format(i,s["global_crops"][i]))
